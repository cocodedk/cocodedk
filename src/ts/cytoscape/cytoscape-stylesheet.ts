/**
 * TypeScript version of the Cytoscape stylesheet module.
 * Generates and returns a stylesheet for Cytoscape.
 */

import { CytoscapeStyle } from '../types/cytoscape';

/**
 * Generates and returns a stylesheet for Cytoscape
 *
 * @return {Array<CytoscapeStyle>} Array of style objects
 */
function getStylesheet(): Array<CytoscapeStyle> {
  return [
    // Base node styling
    {
      selector: 'node',
...
// Create namespace and expose the function for backward compatibility with JavaScript code
...
if (!window.CytoscapeStylesheet) {
  window.CytoscapeStylesheet = {} as CytoscapeStylesheet;
}
